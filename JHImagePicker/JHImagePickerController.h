 ...
 *  获取图片 代理
 */
@protocol JHImagePickerControllerDelegate <NSObject>
...
@interface JHImagePickerController : NSObject
 ...
 *  选取图片结束的代理
 */
@property (nonatomic,weak) id<JHImagePickerControllerDelegate>delegate;
